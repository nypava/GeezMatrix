...
class SymbolColomn:
    def __init__(self,x,y):
        self.colomn_height = randrange(10,20)
        self.speed = randrange(5, 10)
...
font = pg.font.SysFont(name="Power Geez Unicode1",size=font_size)
green_char = [font.render(char,True,pg.Color(0, 255, 70)) for char in characters]
light_green_char = [font.render(char,True,pg.Color(choice(((180, 255, 180),(0, 255, 70))))) for char in characters]
symbolcoloms = [SymbolColomn(x,randrange(-height,0)) for x in range(0,width,font_size-10)]
